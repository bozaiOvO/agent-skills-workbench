...
| `yao-meta-skill` | current | `Current` | selected_by_dev | kept_current | 17 | 1 | 0 | - |
| `yao-meta-skill` | candidate | `Minimal` | not_selected | blocked | 41 | 2 | 0 | weaker_dev_fit, longer_without_gain |
